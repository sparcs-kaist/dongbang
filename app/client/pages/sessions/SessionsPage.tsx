...
import { SessionTitle, SessionItem } from "./components";
...
const SessionsPage: React.FC<SessionsProps> = ({
    sessions,
    currentSessionId,
}) => {
        ...
        <>
            ...
            <List>
                ...
                {sessionGroups.current.map((session) => (
                    <SessionItem session={session} key={session._id} joined />
                ))}
...
const sortSession = (
    sessions: Query<Session>[] | undefined,
