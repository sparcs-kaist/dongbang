...
export const SessionIcon: React.FC<{ className?: string }> = React.memo(({className}) =>
    <svg className={className} viewBox="5 5 145 145" xmlns="http://www.w3.org/2000/svg"
         overflow="hidden" fill="#BFBFBF">
        <path
...
export const CreateIcon: React.FC<{ className?: string }> = React.memo(({className}) =>
    <svg className={className} viewBox="0 0 24 24" fill="#BFBFBF" xmlns="http://www.w3.org/2000/svg" >
        <path
